...
export function ActionForm({
 ...
 return (
    ...
    >
      ...
      >
        <Send size={15} />
 {busy ? (language === "en" ? "Submitting" : "提交中") : (language === "en" ? "Submit" : "提交")}
      </button>
      {message && (
 <p className={`mt-2 text-xs ${message.tone === "error" ? "text-rose-600 dark:text-rose-400" : "text-emerald-600 dark:text-emerald-400"}`}>
 {message.text}
        </p>
      )}
    </form>
